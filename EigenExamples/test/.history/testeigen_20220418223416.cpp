...
// std::cout << T2 <<endl;
 ...
 Eigen::Quaterniond quaternion(-0.00971711,-0.116097,0.992908,0.0236306);
...
Eigen::Vector3d Khat;
Khat=K_marker_Initial.axis();
std::cout<<"Khat_marker_Initial_Eigen"<<Khat[0]<<" "<<Khat[1]<<" "<<Khat[2]<<" "<<std::endl;
