...
Eigen::Vector3d euler_angles =rotation_matrix.eulerAngles(2,1,0);//旋转矩阵转成Euler
...
R_end_to_base[2,1]=-sin(Tcp_pose[4]);
R_end_to_base[2,2]=cos(Tcp_pose[4])*sin(Tcp_pose[3]);
R_end_to_base[2,3]=cos(Tcp_pose[4])*cos(Tcp_pose[3]);
